...
root = Tk()
root.title("Gas law. Isochoric process")
...
Task = Label(text = "Enter the p value at which the isochore process will run: ")
Task.grid(row = 1, column = 0, sticky = "w")
Task1 = Label(text = "Enter the V value at which the isochore process will run: ")
Task1.grid(row = 2, column = 0, sticky = "w")
Task2 = Label(text = "Enter the T value at which the isochore process will run: ")
Task2.grid(row = 3, column = 0, sticky = "w")
Task3 = Label(text = "Enter the m value at which the isochore process will run: ")
