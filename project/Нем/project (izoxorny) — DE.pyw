...
warn1 = Label(text = "Die Formel wird mit allen Zeichen ohne Leerzeichen eingegeben! Der name des Gesetzes enthält das Wort <<Gesetz>>")
warn1.grid(row = 1, column = 0, sticky = "w")
warn.grid(row = 0, column = 0, sticky = "w")

Task = Label(text = "Geben Sie den Wert p ein, bei dem der isochorprozess ausgeführt wird: ")
Task.grid(row = 2, column = 0, sticky = "w")
Task1 = Label(text = "Geben Sie den Wert V ein, bei dem der isochorprozess ausgeführt wird: ")
Task1.grid(row = 3, column = 0, sticky = "w")
Task2 = Label(text = "Geben Sie den Wert T ein, bei dem der isochorprozess ausgeführt wird: ")
Task2.grid(row = 4, column = 0, sticky = "w")
Task3 = Label(text = "Geben Sie den Wert m ein, bei dem der isochorprozess ausgeführt wird: ")
