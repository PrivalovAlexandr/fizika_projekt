...
root = Tk()
root.title("Plynové zákony. Izobarický děj")
...
Task = Label(text = "Zadejte hodnotu p, ve které bude proveden izobarický děj: ")
Task.grid(row = 1, column = 0, sticky = "w")
Task1 = Label(text = "Zadejte hodnotu V, která provede izobarický děj: ")
Task1.grid(row = 2, column = 0, sticky = "w")
Task2 = Label(text = "Zadejte hodnotu T, která provede izobarický děj: ")
Task2.grid(row = 3, column = 0, sticky = "w")
Task3 = Label(text = "Zadejte hodnotu m, která provede izobarický děj: ")
