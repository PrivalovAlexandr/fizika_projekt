...
root = Tk()
root.title("Plynové zákony. Isochorický proces")
...
Task = Label(text = "Zadejte hodnotu p, ve které bude proveden isochorický děj: ")
Task.grid(row = 1, column = 0, sticky = "w")
Task1 = Label(text = "Zadejte hodnotu V, ve které bude proveden isochorický děj: ")
Task1.grid(row = 2, column = 0, sticky = "w")
Task2 = Label(text = "Zadejte hodnotu T, ve které bude proveden isochorický děj: ")
Task2.grid(row = 3, column = 0, sticky = "w")
Task3 = Label(text = "Zadejte hodnotu m, ve které bude proveden isochorický děj: ")
