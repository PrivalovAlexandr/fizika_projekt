...
root = Tk()
root.title("Газовые законы. Изотермический процесс")
...
Task = Label(text = "Введите значение p, при котором будет выполняться изотермический процесс: ")
Task.grid(row = 1, column = 0, sticky = "w")
Task1 = Label(text = "Введите значение V, при котором будет выполняться изотермический процесс: ")
Task1.grid(row = 2, column = 0, sticky = "w")
Task2 = Label(text = "Введите значение T, при котором будет выполняться изотермический процесс: ")
Task2.grid(row = 3, column = 0, sticky = "w")
Task3 = Label(text = "Введите значение m, при котором будет выполняться изотермический процесс: ")
